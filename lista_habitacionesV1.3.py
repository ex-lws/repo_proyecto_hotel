...
#Versión 1.2
#Fecha: 03/09/2024
#Autor: Guillermo Lopéz González

#Correciones: Cambios en el ciclo for para poder mostrar de manera más organizada a la información contenida en los diccionarios.

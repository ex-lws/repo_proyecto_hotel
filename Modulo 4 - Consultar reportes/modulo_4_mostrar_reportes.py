# Clase - Modulo para poder realizar una consulta a los reportes de reservacion existentes

# En la base de datos se realizó una vista que permite reunir datos de las tablas principales sin modificar datos.
